...
namespace EoaServer.Transfer.Provider;
...
public class NetworkCacheProvider : INetworkCacheProvider, ISingletonDependency
{
    ...
    public NetworkCacheProvider(IOptionsSnapshot<ChainOptions> chainOptions)
    {
