...
public class EoaServerApplicationTestConstant
{
    public const string ChainIdAELF = "AELF";
    public const string ChainIdTDVW = "tDVW";
    public const string User1Address = "0x12345";
    public const string User2Address = "0x22345";
    public const string ForestContractAddress = "0x10001";
    public const string ProxyAccountContractAddress = "0x10002";
    public const string TransferContractAddress = "0x10003";
